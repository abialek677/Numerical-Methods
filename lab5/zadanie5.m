...
M = 20; % liczba węzłów interpolacji wzdłuż osi X (stopień wielomianu zmiennej x: M-1)
N = 20; % liczba węzłów interpolacji wzdłuż osi Y (stopień wielomianu zmiennej y: N-1)
...
ylabel('y')
zlabel('value')
title('Function value for coarse nodes')
...
ylabel('y')
zlabel('value')
title('Function value for fine nodes')
